            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <div className="flex items-center gap-2 ml-3 pl-3 border-l border-gray-200">
                  ...
                  <Link 
                    to="/signup" 
                    className="px-4 py-1.5 rounded-md bg-black text-white text-sm font-medium hover:bg-gray-800 transition-colors"
                  >
                    Sign up
                  </Link>
                </div>
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="w-full text-left px-4 py-2 rounded-md text-sm text-gray-600 hover:bg-red-50 hover:text-red-600 font-medium transition-colors flex items-center gap-2"
                >
                  <LogOut className="w-4 h-4" />
                  Logout
                </button>
              ...
              <>
                ...
                <Link 
                  to="/login"
                  onClick={handleNavClick}
                  className="block px-4 py-2 rounded-md text-sm text-gray-600 hover:bg-gray-50 font-medium transition-colors"
                >
                  Log in
                </Link>
                <Link 
                  to="/signup"
                  onClick={handleNavClick}
                  className="block px-4 py-2 rounded-md text-sm bg-black text-white font-medium hover:bg-gray-800 transition-colors"
                >
                  Sign up
                </Link>
              </>
